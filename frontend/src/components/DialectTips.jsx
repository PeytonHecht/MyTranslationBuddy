...
const S = {
  ...
  cityCardFlag:{position:"absolute",top:"0.6rem",right:"0.6rem",fontSize:"1.2rem",fontWeight:500,color:"#fff",textShadow:"0 1px 3px rgba(0,0,0,1), 1px 0 3px rgba(0,0,0,1)", letterSpacing:"0.3px",opacity:0.95},  cityCardBody:{padding:"0.75rem 0.9rem 0.85rem"},
