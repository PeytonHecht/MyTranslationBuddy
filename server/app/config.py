...
class Settings(BaseSettings):
    ...
    debug: bool = True  # <-- Added this line to fix the run.py crash
    ...
    mongodb_uri: str = os.getenv("MONGODB_URI",
                                 "mongodb+srv://admin:translationbuddy@mythranslationbuddy.r5i1k.mongodb.net/?retryWrites=true&w=majority&appName=MyTranslationBuddy")
